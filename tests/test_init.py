...
async def test_setup_entry(hass: HomeAssistant, mock_phyn_api_setup, mock_coordinator) -> None:
...
async def test_unload_entry(hass: HomeAssistant, mock_phyn_api_setup, mock_coordinator) -> None:
